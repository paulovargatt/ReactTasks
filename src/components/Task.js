...
export default props => {
    ...
    const leftContent = (
        <View style={styles.exclude}>
            <Icon name='trash' size={20} color={commonStyles.colors.secondary}></Icon>
    ...
    const rightContent = [
        <TouchableOpacity style={[styles.exclude, {justifyContent: 'flex-start', paddingLeft: 20}]}
            ...
            <Icon name='trash' size={30} color={commonStyles.colors.secondary}></Icon>
        </TouchableOpacity>
    ]
        ...
        <Swipeable leftActionActivationDistance={200} onLeftActionActivate={() => props.onDelete(props.id)}
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <Text
                        style={styles.date}> {moment(props.estimateAt).locale('pt-br').format('ddd, D [de] MMMM')}</Text>
                </View>
            </View>
        </Swipeable>
    )
